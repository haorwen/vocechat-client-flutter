...
/// @nodoc
mixin _$ServerState {
  List<ServerConfig> get servers => throw _privateConstructorUsedError;
...
abstract class $ServerStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ServerConfig> servers, String? currentServerId});
}
...
class _$ServerStateImpl implements _ServerState {
  const _$ServerStateImpl(
      {final List<ServerConfig> servers = const [], this.currentServerId})
      : _servers = servers;
  ...
  @override
  String toString() {
    return 'ServerState(servers: $servers, currentServerId: $currentServerId)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_servers), currentServerId);
...
abstract class _ServerState implements ServerState {
  const factory _ServerState(
      ...
      final String? currentServerId}) = _$ServerStateImpl;
